    ...
    return(
        <article class="post">
            ...
            <section class="fundo">
                <section class="acoes">
                    <div>
                        {like ? (<ion-icon className="liked md hydrated" onClick={() => setLike(!like)} name="heart" aria-label="heart" ></ion-icon>):(<ion-icon className="md hydrated" onClick={() => setLike(!like)} name="heart-outline"></ion-icon>)}
